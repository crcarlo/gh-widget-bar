function addCss() {
	var style_content = `.gh-widget-bar{color:#666;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Helvetica,Arial, sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"}.gh-widget-bar a{color:inherit;text-decoration:none!important}.gh-widget-bar h3{padding:0;margin:0}.gh-widget-bar svg{fill:#fff}.gh-widget-bar .gh-wid-head{display:flex;padding:5px;color:#fff;font-weight:600;background-color:#24292e;border-radius:3px 3px 0 0}.gh-widget-bar .gh-wid-head .logo{display:inline-block}.gh-widget-bar .gh-wid-head .title{margin-left:8px}.gh-widget-bar .gh-wid-body{border-color:#ccc;border-style:solid;border-width:1px;border-radius:0 0 3px 3px;padding:8px;display:flex;justify-content:space-between}.gh-widget-bar .gh-wid-body .gh-link{font-size:15;float:left;width:23%;min-width:220px}.gh-widget-bar .gh-wid-body .gh-link .gh-wid-avatar{float:left;margin-right:10px}.gh-widget-bar .gh-wid-body .gh-link .gh-wid-avatar img{border-radius:4px;width:60px;height:60px}.gh-widget-bar .gh-wid-body .gh-link .gh-wid-name-box{float:left}.gh-widget-bar .gh-wid-body .gh-link .gh-wid-name-box .gh-wid-name{color:#24292e;font-weight:600}.gh-widget-bar .gh-wid-body .gh-wid-bio{font-size:13;float:left;width:42%;padding:5px 8px 5px 8px}.gh-widget-bar .gh-wid-body .gh-stats{float:left;width:35%;font-size:13;display:flex;justify-content:space-between;max-width:280px}.gh-widget-bar .gh-wid-body .gh-stats a{display:flex;flex-direction:column;align-items:center}@media (min-width:601px) and (max-width:767px){.gh-widget-bar .gh-wid-body .gh-stats>*{margin-bottom:8px}}@media (max-width:767px){.gh-widget-bar .gh-wid-body .gh-stats>* a{justify-content:space-between;flex-direction:row}}.gh-widget-bar .gh-wid-body .gh-stats .gh-number{display:block;height:25px;width:25px;background-color:#eee;font-weight:600;border-radius:15px;text-align:center;margin-top:7px}.gh-widget-bar .gh-wid-body .gh-stats .gh-number span{display:block;padding-top:calc(50% - 8.5px)}@media (max-width:767px){.gh-widget-bar .gh-wid-body .gh-stats .gh-number{margin-top:0}}@media (min-width:601px) and (max-width:767px){.gh-widget-bar .gh-wid-body .gh-stats{flex-direction:column;justify-content:unset}}@media (max-width:600px){.gh-widget-bar .gh-wid-body{flex-wrap:wrap}.gh-widget-bar .gh-wid-body .gh-link{width:50%}.gh-widget-bar .gh-wid-body .gh-stats{width:100%;max-width:none}.gh-widget-bar .gh-wid-body .gh-stats .gh-number{margin-left:8px}}`;
